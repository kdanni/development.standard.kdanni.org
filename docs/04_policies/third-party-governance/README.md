...
> ⚠️ **Placeholder:** Elaborate with scope, roles, approval workflows, evidence expectations, and exception handling. Add sections on security validation, intellectual property, incident responsibilities, and alignment with contracting and access governance policies.
