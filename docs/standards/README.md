...
They should articulate the rationale behind the rule and how adherence is validated.

## Outline
- **Architecture standards** – Service boundaries, API design principles, and dependency rules.
...
- **Quality gates** – Testing coverage thresholds, performance targets, and release readiness criteria.
- **Documentation of rationale** – Required sections that capture context, trade-offs, and decision records.
