...
| `docs/05_processes/` | Documents operational workflows such as testing, deployment, incident response, and maintenance. | Operations working group | Processes map steps to roles, inputs, outputs, and success metrics. |
| `docs/06_references/` | Provides glossaries, acronym lists, technology matrices, and evergreen reference material. | Knowledge management team | Keep references versioned and cross-linked to dependent documents. |
| `docs/07_templates/` | Offers reusable templates, checklists, and forms that accelerate consistent documentation. | Knowledge management team | Each template includes short usage notes pointing to relevant guidance. |
