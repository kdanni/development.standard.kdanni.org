...
4. **Author content** – Write Markdown documents that:
   ...
   - Reference related documents with full paths (e.g., `docs/05_processes/testing.md`).
   - Start from the [Document Template](../docs/07_templates/document-template.md) to keep structure consistent.
...
- **Internal links** – Prefer relative links (e.g., `[Process Outline](../05_processes/README.md)`) so navigation works
  in any context.
...
- Use pull request templates (once added under `docs/07_templates/`) to ensure each submission captures context,
